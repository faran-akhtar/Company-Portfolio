   ...
   <header id="home" style="background: #161415 url(<?php echo validate_image($_settings->info('banner')) ?>) no-repeat top center;">
      ...
      <nav id="nav-wrap">
         ...
         <ul id="nav" class="nav">
           ...
           <li><a class="smoothscroll" href="#resume">Portfolio</a></li>
           <li><a class="smoothscroll" href="#clients">Services</a></li>
            <li><a class="smoothscroll" href="#testimonials">Team</a></li>
   ...
   <section id="resume">
      ...
      <div class="row education">
         ...
         <div class="three columns header-col">
            <h1><span>Company Portfolio</span></h1>
         </div>
